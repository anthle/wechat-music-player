...
__DEFINE__(1671547281145, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1671547281146,"./event-store":1671547281147}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1671547281146, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1671547281147, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1671547281146,"./utils":1671547281148}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1671547281148, function(require, module, exports) {
...
return __REQUIRE__(1671547281145);
})()
